...
data class PresentationReport(
    ...
    val durationSec:     Int,
    val createdAt:       Long,
    val fullTranscript:  String,          // ← 추가: 발표 전체 STT 스크립트
    ...
    companion object {
        ...
        fun fromJson(json: String): PresentationReport =
            gson.fromJson(json, PresentationReport::class.java)
    }
}
...
object ReportBuilder {
    ...
    fun build(
        durationSec:         Int,
        fullTranscript:      String,                     // ← 추가
        wpmHistory:          List<Pair<Double, Int>>,
        fillerResult:        FillerAnalysisResult,
        voiceResults:        List<VoiceAnalysisResult>,
        ...
        val speedReport = SpeedAnalysisReport(
            ...
            fastSections = findSections(wpmHistory) { it >= 200 },
            slowSections = findSections(wpmHistory) { it in 1..79 },
        ...
        val voiceReport = VoiceAnalysisReport(
            ...
            tremorSections       = findTremorSections(voiceResults),
        ...
        return PresentationReport(
            ...
            fullTranscript = fullTranscript,              // ← 추가
    ...
    private fun findTremorSections(results: List<VoiceAnalysisResult>) =
        results.mapIndexedNotNull { i, r ->
            if (r.tremorPercent >= 60)
                TimedSection(i * 3.0, i * 3.0 + 3.0, r.tremorPercent)
            else null
        }
